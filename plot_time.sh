...
python experiments/plot_time.py --env Walker2d-v1 --t 500 --max_data 400 --num_evals 8 --save --config net64-64
...
python experiments/plot_time.py --env Hopper-v1 --t 500 --max_data 400 --num_evals 8 --save --config net64-64
...
python experiments/plot_time.py --env HalfCheetah-v1 --t 500 --max_data 400 --num_evals 8 --save --config net64-64
...
python experiments/plot_time.py --env Humanoid-v1 --t 500 --max_data 10000 --num_evals 8 --save --config net64-64
